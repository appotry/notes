...
[GitHub dockerfile](https://github.com/tensorflow/serving/tree/master/tensorflow_serving/tools/docker)
...
该脚本可以写入`tensorflow_model_server`启动命令, 启动容器的时候将model映射到容器内.
